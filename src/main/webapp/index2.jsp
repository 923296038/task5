            ...
            <div class="warp-border">
                ...
                <div class="warp-class2">
                    <div class="warp-class2-text">
                        <div class="iconfont text-padding">门槛 <img src="other/images2/xx.png"></div>
                    </div>
                    <div class="warp-class2-text">
                        <div class="iconfont text-padding text-border-left">难易程度 <img src="other/images2/xx.png"><img src="other/images2/xx.png"></div>
                    </div>
                </div>
                <div class="warp-class2">
                    <div class="warp-class2-text">
    ...
    <div class="container height">
        <div class="row">
            ...
            <div class="text-right col-sm-4">
                <p>微信公众号</p>
                <img src="other/images2/2524.jpg">
            </div>
        </div>
